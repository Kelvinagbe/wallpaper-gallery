      ...
      <div className="fixed bottom-0 left-0 right-0 z-[101]" style={{ animation: 'slideUp .3s cubic-bezier(.34,1.56,.64,1)' }}>
        <div className="bg-white rounded-t-3xl shadow-2xl max-w-2xl mx-auto px-4 pb-8">
          ...
          <div className="flex flex-col gap-0.5">
            {items.map((b, i) => (
              <button key={i} onClick={b.onClick} className={`w-full flex items-center gap-4 px-3 py-3.5 hover:bg-gray-50 active:bg-gray-100 rounded-2xl transition-colors active:scale-[0.98] ${b.border ? 'mt-3 border-t border-gray-100' : ''}`}>
